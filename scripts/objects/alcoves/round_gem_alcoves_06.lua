...
-- lower - center
defineObject{
	name = "round_gem_alcove_06_l_c",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_06_l_c.fbx",
...
-- center - center
defineObject{
	name = "round_gem_alcove_06_c_c",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_06_c_c.fbx",
...
-- upper - center
defineObject{
	name = "round_gem_alcove_06_u_c",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_06_u_c.fbx",
...
-- lower - left
defineObject{
	name = "round_gem_alcove_06_l_l",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_06_l_l.fbx",
...
-- center - left
defineObject{
	name = "round_gem_alcove_06_c_l",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_06_c_l.fbx",
...
-- upper - left
defineObject{
	name = "round_gem_alcove_06_u_l",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_06_u_l.fbx",
...
-- lower - right
defineObject{
	name = "round_gem_alcove_06_l_r",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_06_l_r.fbx",
	anchorPos = vec(0.5, 1.1, -0.08),
	anchorRotation = vec(45, 0, 90),
	targetPos = vec(0.5, 1.1, 0),
	targetSize = vec(0.05, 0.05, 0.05),
...
-- center - right
defineObject{
	name = "round_gem_alcove_06_c_r",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_06_c_r.fbx",
	anchorPos = vec(0.5, 1.6, -0.08),
	anchorRotation = vec(45, 0, 90),
	targetPos = vec(0.5, 1.6, 0),
	targetSize = vec(0.05, 0.05, 0.05),
...
-- upper - right
defineObject{
	name = "round_gem_alcove_06_u_r",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_06_u_r.fbx",
	anchorPos = vec(0.5, 2.1, -0.08),
	anchorRotation = vec(45, 0, 90),
	targetPos = vec(0.5, 2.1, 0),
	targetSize = vec(0.05, 0.05, 0.05),
