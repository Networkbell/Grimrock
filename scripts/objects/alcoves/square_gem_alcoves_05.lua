...
-- lower - center
defineObject{
	name = "square_gem_alcove_05_l_c",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/square_gem_alcove_05_l_c.fbx",
...
-- center - center
defineObject{
	name = "square_gem_alcove_05_c_c",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/square_gem_alcove_05_c_c.fbx",
...
-- upper - center
defineObject{
	name = "square_gem_alcove_05_u_c",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/square_gem_alcove_05_u_c.fbx",
...
-- lower - left
defineObject{
	name = "square_gem_alcove_05_l_l",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/square_gem_alcove_05_l_l.fbx",
...
-- center - left
defineObject{
	name = "square_gem_alcove_05_c_l",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/square_gem_alcove_05_c_l.fbx",
...
-- upper - left
defineObject{
	name = "square_gem_alcove_05_u_l",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/square_gem_alcove_05_u_l.fbx",
...
-- lower - right
defineObject{
	name = "square_gem_alcove_05_l_r",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/square_gem_alcove_05_l_r.fbx",
	anchorPos = vec(0.5, 1.1, -0.07),
	anchorRotation = vec(45, 0, 0),
	targetPos = vec(0.5, 1.1, 0),
	targetSize = vec(0.05, 0.05, 0.05),
...
-- center - right
defineObject{
	name = "square_gem_alcove_05_c_r",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/square_gem_alcove_05_c_r.fbx",
	anchorPos = vec(0.5, 1.6, -0.07),
	anchorRotation = vec(45, 0, 0),
	targetPos = vec(0.5, 1.6, 0),
	targetSize = vec(0.05, 0.05, 0.05),
...
-- upper - right
defineObject{
	name = "square_gem_alcove_05_u_r",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/square_gem_alcove_05_u_r.fbx",
	anchorPos = vec(0.5, 2.1, -0.07),
	anchorRotation = vec(45, 0, 0),
	targetPos = vec(0.5, 2.1, 0),
	targetSize = vec(0.05, 0.05, 0.05),
