...
-- lower - center
defineObject{
	name = "round_gem_alcove_01_l_c",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_01_l_c.fbx",
	anchorPos = vec(0, 1.1, -0.075),
...
-- center - center
defineObject{
	name = "round_gem_alcove_01_c_c",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_01_c_c.fbx",
	anchorPos = vec(0, 1.6, -0.075),
	anchorRotation = vec(45, 0, 0),
...
-- center - left
defineObject{
	name = "round_gem_alcove_01_c_l",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_01_c_l.fbx",
...
-- upper - left
defineObject{
	name = "round_gem_alcove_01_u_l",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_01_u_l.fbx",
...
-- lower - right
defineObject{
	name = "round_gem_alcove_01_l_r",
	class = "Alcove",
	model = "mod_assets/models/env/alcoves/round_gem_alcove_01_l_r.fbx",
	anchorPos = vec(0.5, 1.1, -0.075),
	anchorRotation = vec(45, 0, 0),
	targetPos = vec(0.5, 1.1, 0),
	targetSize = vec(0.05, 0.05, 0.05),
